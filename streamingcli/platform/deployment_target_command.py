...
class DeploymentTargetCommand:
    ...
    def create_deployment_target(kubernetes_namespace: str,
        ...
        if profile.ververica_url is not None and profile.ververica_namespace is not None \
            ...
            raise click.ClickException("Missing one of deployment attribute: ververica_namespace, "
