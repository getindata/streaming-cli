...
class LoginCommand:
    @staticmethod
    def docker_login(username: str, password: str, profile: Optional[str] = None) -> None:
        ...
        client.login(username, password, registry=profile_data.docker_registry_url, reauth=True)
        ...
        LoginCommand.update_docker_auths_config(username, password, profile_data.docker_registry_url)
