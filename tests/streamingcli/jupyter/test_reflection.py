...
from streamingcli.jupyter.reflection import get_method_names_for, get_decorators_for_method
import collections
...
class TestReflection:
    ...
    def test_get_method_names_for_cell_magic(self):
        ...
        assert collections.Counter(['static_method_with_cell_magic', 'method_with_cell_magic']) \
    ...
    def test_get_method_names_for_line_magic(self):
        ...
        assert collections.Counter(['method_with_other_magic']) == collections.Counter(method_list)
    ...
    def test_get_decorators_for_method(self):
        ...
        assert collections.Counter(['method_without_decorator',
        ...
        assert collections.Counter([]) == collections.Counter(decorators_for_methods['method_without_decorator'])
        assert collections.Counter(["Name(id='cell_magic', ctx=Load())", "Name(id='staticmethod', ctx=Load())"]) \
               == collections.Counter(decorators_for_methods['static_method_with_cell_magic'])
        assert collections.Counter(["Name(id='cell_magic', ctx=Load())"]) \
               == collections.Counter(decorators_for_methods['method_with_cell_magic'])
        assert collections.Counter(["Name(id='line_magic', ctx=Load())"]) \
